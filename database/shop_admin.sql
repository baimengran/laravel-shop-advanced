...
insert  into `admin_menu`(`id`,`parent_id`,`order`,`title`,`icon`,`uri`,`created_at`,`updated_at`) values (1,0,1,'首页','fa-bar-chart','/',NULL,'2018-09-16 08:41:50'),(2,0,7,'系统管理','fa-tasks',NULL,NULL,'2018-10-15 23:45:46'),(3,2,8,'管理员','fa-users','auth/users',NULL,'2018-10-15 23:45:46'),(4,2,9,'角色','fa-user','auth/roles',NULL,'2018-10-15 23:45:46'),(5,2,10,'权限','fa-ban','auth/permissions',NULL,'2018-10-15 23:45:46'),(6,2,11,'菜单','fa-bars','auth/menu',NULL,'2018-10-15 23:45:46'),(7,2,12,'操作日志','fa-history','auth/logs',NULL,'2018-10-15 23:45:46'),(8,0,2,'用户管理','fa-user','/users','2018-09-17 07:32:28','2018-09-17 07:33:09'),(9,0,4,'商品管理','fa-cubes','/products','2018-09-17 10:08:23','2018-10-15 23:45:45'),(10,0,5,'订单管理','fa-rmb','/orders','2018-10-04 16:56:00','2018-10-15 23:45:45'),(11,0,6,'优惠卷管理','fa-tags','/coupon_codes','2018-10-09 19:36:44','2018-10-15 23:45:46'),(12,0,3,'类目管理','fa-bars','/categories','2018-10-15 23:45:27','2018-10-15 23:45:45');
